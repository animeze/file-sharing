...
@Bot.on_message(filters.private & filters.user(ADMINS) & ~filters.command(['start','users','broadcast','batch','genlink','stats', 'adduser', 'removeuser', 'listuser', 'listjav', 'listwes', 'addjav', 'addwes'], 'removejav', 'removewes'))
