...
@Bot.on_message(filters.private & filters.user(ADMINS) & ~filters.command(['start','users','broadcast','batch','genlink','stats','adduser','removeuser','listuser','listdesi','listam','adddesi','addam','removedesi','removeam','addhentai','removehentai','listhentai','fuck']))
