...
DB_NAME = os.environ.get("DATABASE_NAME", "Shankss")

#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1001199007342"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "1040033572").split()):
        ADMINS.append(int(x))
except ValueError:
